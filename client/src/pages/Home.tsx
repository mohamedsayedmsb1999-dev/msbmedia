  ...
  return <SiteShell>
    <section className="hero-grid relative overflow-hidden">
      <div className="site-container grid min-h-[650px] items-center gap-10 py-16 lg:grid-cols-[1.08fr_.92fr]">
        ...
        <div className="relative mx-auto w-full max-w-md"><div className="absolute -inset-8 rounded-full bg-[#165ac4]/20 blur-3xl"></div><div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#07133c] p-5 shadow-2xl"><HeroStudioImage src={AGENCY_IMAGE} /><div className="absolute bottom-7 right-9 left-9 rounded-2xl border border-white/10 bg-[#020615]/85 px-3 py-2.5 backdrop-blur"><p className="text-[9px] font-black tracking-[.12em] text-[#ffd400]">MSB MEDIA</p><p className="mt-1 text-[11px] font-bold leading-4 sm:text-xs">خدمات رقمية ومحتوى وإعلانات ضمن مسار واضح</p></div></div></div>
      </div>
    </section>
