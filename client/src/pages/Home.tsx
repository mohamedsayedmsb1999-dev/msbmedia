...
export default function Home() {
  ...
  return <SiteShell>
    ...
    <ScrollReveal delay={80}><section className="site-container pb-20"><PromoVideo /></section></ScrollReveal>
    ...
    <section className="border-y border-white/10 bg-[#07133c] py-20">
      <div className="site-container grid gap-8 lg:grid-cols-[.9fr_1.1fr]">
        <div><span className="eyebrow">تدقيق تسويقي سريع</span><h2 className="section-title">ثلاث إجابات، ونقطة بداية أوضح</h2><p className="mt-4 max-w-md leading-8 text-slate-300">اختر إجابة واحدة في كل خطوة لنحوّلها إلى تدقيق مبدئي يرسله فريقنا إلى محادثة واتساب.</p><div className="mt-8 flex items-center gap-3 text-sm font-black"><span className="grid h-10 w-10 place-items-center rounded-xl bg-[#ffd400] text-[#020615]">{done ? quiz.length : step + 1}</span><span>الخطوة {done ? quiz.length : step + 1} من {quiz.length}</span></div></div>
