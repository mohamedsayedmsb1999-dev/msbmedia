import { ArrowLeft, Check, CheckCircle2, MessageCircle, Route, ShieldCheck, Sparkles } from "lucide-react";
...
export default function Services() {
  ...
  return <SiteShell>
    <section className="page-hero"><div className="site-container"><span className="eyebrow"><Sparkles className="h-4 w-4" />خدماتنا</span><h1>حلول متصلة، لا مهام منفصلة</h1><p>نحن نرتّب الأدوات والإبداع والأداء داخل مسار يناسب هدف مشروعك. خدماتنا وعرض الفيديو والمراجعات والتدقيق التسويقي موجودة هنا، في صفحة واحدة مستقلة.</p></div></section>
