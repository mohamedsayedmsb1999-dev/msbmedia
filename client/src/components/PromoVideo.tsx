...
import { mediaUrl, openWhatsApp, UGC_VIDEO } from "@/lib/site-data";
import WhatsAppIcon from "@/components/WhatsAppIcon";

const VIDEO_URL = UGC_VIDEO;
const VIDEO_POSTER = mediaUrl("service-ugc-storyboard_ff83d037.png");
