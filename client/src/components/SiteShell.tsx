...
import { BrainCircuit, Facebook, Globe2, LogIn, Megaphone, Menu, MonitorSmartphone, Share2, X, Youtube } from "lucide-react";
...
const footerCapabilities = [
  { label: "إعلانات رقمية", icon: Megaphone },
  { label: "مواقع ومنصات", icon: MonitorSmartphone },
  { label: "حلول Google", icon: Globe2 },
  { label: "إنتاج بالذكاء الاصطناعي", icon: BrainCircuit },
];
