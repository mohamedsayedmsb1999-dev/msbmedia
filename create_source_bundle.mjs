...
1. افتح GitHub ثم اختر **New repository** وسمّه \`msb-media\` واجعله Private في البداية.
2. على الكمبيوتر، فك هذا الملف في مجلد مشروع بعد نسخ الملفات كل ملف إلى المسار المكتوب أعلى قسمه. الأسهل هو تنزيل نسخة المشروع الكاملة من مساحة المشروع، أو استعمال هذا TXT كمرجع للمصدر.
3. ارفع ملفات المشروع كلها إلى المستودع، مع وجود \`package.json\` و\`vercel.json\` في الجذر. لا ترفع \`node_modules\` أو \`dist\` أو أي ملف \`.env\` أو كلمات مرور.
4. أنشئ Commit ثم اضغط **Push** إلى فرع \`main\`.
...
1. داخل مشروع Vercel افتح **Settings → Domains** وأضف اسم الدومين الذي اشتريته.
